...
import TopicDivision from '../TopicDivision';
...
describe('TopicDivision Component', () => {
  let originalError;
  beforeAll(() => {
  ...
  test('Render', async () => {
    ...
    expect(screen.queryAllByText("farm")).toHaveLength(0)
    expect(screen.queryAllByText("Farm")).toHaveLength(1)
